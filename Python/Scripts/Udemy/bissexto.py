...
Você também pode utilizar a função monthrange de calendar
para pegar o número do dia na semana (entre 0-6) e
último dia do mês (entre 28-31), exemplo: """
...
Caso queira retornar apenas um valor, pode fazer o desempacotamento, assim: """
